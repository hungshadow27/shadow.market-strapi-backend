...
export interface ApiNotificationNotification
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['follow', 'love', 'new-subscriber-post', 'post-approve']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    statusN: Schema.Attribute.Enumeration<['new', 'old', 'out']> &
      Schema.Attribute.DefaultTo<'old'>;
    statusP: Schema.Attribute.Enumeration<['active', 'inactive', 'sold']> &
...
export interface ApiSavepostSavepost extends Struct.CollectionTypeSchema {
  collectionName: 'saveposts';
  info: {
    displayName: 'savepost';
    pluralName: 'saveposts';
    singularName: 'savepost';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiShortVideoShortVideo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    relatedPost: Schema.Attribute.Relation<'oneToOne', 'api::post.post'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['recharge', 'buy_vip', 'push_post']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    balance: Schema.Attribute.BigInteger & Schema.Attribute.DefaultTo<'0'>;
    ...
    vipExpireAt: Schema.Attribute.DateTime;
    ward: Schema.Attribute.Relation<'oneToOne', 'api::ward.ward'>;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::savepost.savepost': ApiSavepostSavepost;
